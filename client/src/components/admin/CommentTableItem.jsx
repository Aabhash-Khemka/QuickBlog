      ...
      <td className='px-6 py-4 max-sm:hidden'>
        ...
        <div className='inline-flex items-center gap-4'>
            ...
            <img onClick={approveComment} src={assets.tick_icon} className='w-5 hover:scale-110 transition-all cursor-pointer'/> :
             <p className='text-xs border border-green-100 bg-green-100 text-green-600 rounded-full px-3 py-1'>Approved</p>}
       <img onClick={deleteComment} src={assets.bin_icon} alt="" className='hover: cursor-pointer hover:scale-110 w-5 transition-all' />
        </div>
      </td>
    </tr>
  )
