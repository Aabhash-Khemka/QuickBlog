  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <p className='inline-block py-1 px-4 rounded-full mb-6 border text-sm border-primary/35 bg-primary/5 font-medium text-primary'>{data.author?.name || 'Author'}</p>
      </div>

      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-10'>
        ...
        <div className='max-w-3xl mx-auto'>
          ...
          <form onSubmit={(e) => addComment(e)} className='flex flex-col items-start gap-4 max-w-lg'>
            ...
            <textarea onChange={(e) => setContent(e.target.value)} value={content} name="" id="" placeholder='Comment' required className='w-full p-2 border border-gray-300 rounded outline-none h-48'></textarea>
